...
const features = [
  {
    name: 'Find food near you',
    description:
      'Whether it’s fine dining or street food, there is always an option nearby',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Relive your food experiences',
    description:
      "Videos save memories of places you've been to for you to view at a later date",
  ...
  },
  {
    ...
    description:
      'Watch your food intake drain your wallet, leaving you penniless',
